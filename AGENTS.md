...
- A narrow mechanical fix should use focused tests first and be batched before the eventual exact-head merge gate. Do not weaken, skip, or relabel required tests/review to save compute, time, or context.
