...
| Customer Proof Packet | Active Docker product surface | Summarizes completed Docker-local claims, validation commands, proof sources, next blockers, and explicit non-claims in one customer-readable packet. |
...
| Docker customer proof packet | Active Docker proof gate | Verifies `/api/proof-packet` exposes completed Docker-local claims, validation commands, proof sources, next blockers, and explicit non-claims without automatic claim promotion. |
