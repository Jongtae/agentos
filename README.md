...
| Product Layer Map | Active Docker product surface | Shows the recommended customer path and reviewer routes across Runtime Home, onboarding, guided demo, safe work, evidence, handoff, proof promotion, and observed-proof blockers. |
...
| Docker Product Layer map | Active Docker proof gate | Verifies `/api/product-map` exposes start, safe-work, proof/handoff, blocked-until-observed surface groups, and reviewer routes without adding stronger proof claims. |
