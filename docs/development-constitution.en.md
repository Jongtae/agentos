...
- **Spec**: after checking whether an existing contract, standard or concept already covers the behavior (C15), state owner outcome, behavior, boundaries, non-goals and acceptance criteria without prematurely selecting an implementation.
