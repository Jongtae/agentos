...
| EPIC-PA1 / [#386](https://github.com/Jongtae/personal-agentos/issues/386) | **Active** since 2026-09-22 by explicit owner direction, recorded in [GOV-PA1-04 / #443](https://github.com/Jongtae/personal-agentos/issues/443); paused for the EPIC-REUSE-01 tranche by #419 before that. Wave 1 merged; only the enumerated remaining substeps may advance — PA1-CONV-01 / #393 then PA1-INT-01 / #394 — under [PA1 parallel delivery](pa1-parallel-delivery.en.md). Goal-ready is not execution. Journeys J1–J8 are not met and are not claimed. |
