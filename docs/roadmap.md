...
| PRESENCE-01 / [#508](https://github.com/Jongtae/agentos/issues/508) | **Active top-level goal.** GitHub Issues/PRs/Checks are authoritative for completed execution. Completed foundations and follow-ups are regression inputs, not work to repeat. Remaining sequence: [#494](https://github.com/Jongtae/agentos/issues/494) → [#506](https://github.com/Jongtae/agentos/issues/506) → [#505](https://github.com/Jongtae/agentos/issues/505) → [#559](https://github.com/Jongtae/agentos/issues/559) → [#562](https://github.com/Jongtae/agentos/issues/562) → [#447](https://github.com/Jongtae/agentos/issues/447) → [#512](https://github.com/Jongtae/agentos/issues/512) → [#513](https://github.com/Jongtae/agentos/issues/513). #506 is limited to remaining authoritative Settings state/action semantics; #559 is limited to missing relation/Evidence/provenance read-model work. Next: #494. #383/#437/#445 are outside the current Presence execution queue. |
