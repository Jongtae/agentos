...
| EPIC-FU1 / [#501](https://github.com/Jongtae/agentos/issues/501) | Owner-activated and goal-ready by GOV-FU1-01 / [#502](https://github.com/Jongtae/agentos/issues/502) (owner direction 2026-09-23). Removes the four P1 first-use dead ends found by TEST-FIRST-USER-01 / #472, one substep at a time: FU1-474 / #474 (complete on merge of #519) → FU1-473 / #473 → FU1-475 / #475 → FU1-482 / #482. Reuses only connectors, grants, OAuth routes and approval APIs already on `main`; no new connector, scope, destination or live operation. Evidence class: automated synthetic/fixture only. Completion does not select a successor. |
