...
| PRESENCE-01 / [#508](https://github.com/Jongtae/agentos/issues/508) | **Active top-level goal.** Owner-selected model-first Presence on 2026-09-24 by GOV-PRESENCE-ACT-01 / [#523](https://github.com/Jongtae/agentos/issues/523) (PR #524, 7396347). Ordered children: PRESENCE-DEC-01 / #417 → PRESENCE-CONV-01 / #510 → PRESENCE-CONT-01 / #511 → #494 / #504 / #505 / #506 as dependency and file ownership permit → PRESENCE-EVAL-01 / #512 → PRESENCE-README-01 / #513. Semantic product decisions go through the provider-neutral DecisionEngine (`docs/decision-layer.en.md`; `gpt-4o-mini` initial default provider); deterministic code remains authoritative for Grant/approval/idempotency/effect/Evidence invariants. Progress: PRESENCE-DEC-01 (#527), PRESENCE-CONV-01 (#530) and PRESENCE-AI-01 (#537, #540) merged; owner-directed ENGINE-DIAG-01 / #533 (#536), TG-VERIFY-01 / #541 (#543) and the presentation-only #506 slices (#531; PRESENCE-SETTINGS-FILES-01 / #551 via #552, 44d4d40; UI-QUALITY-01 / #558 via #563, 9fb833d; fixture evidence only) recorded without changing program order; the rest of #506 stays gated by #511. Next: PRESENCE-CONT-01 / #511. Evidence class: automated fixture evidence per child; one live Codex turn on the owner instance observed after ENGINE-DIAG-01 (2026-09-24); no Presence-level live acceptance claimed. |
