...
| PRESENCE-01 / [#508](https://github.com/Jongtae/agentos/issues/508) | **Active top-level goal.** GitHub Issues/PRs/Checks are authoritative for completed execution. Completed foundations and follow-ups are regression inputs, not work to repeat. Completed since activation: #494, #506 (Google revoke split to [#588](https://github.com/Jongtae/agentos/issues/588), proposed), #505, #580. Remaining sequence (owner decisions 2026-09-25; up to two non-overlapping children at once): [#559](https://github.com/Jongtae/agentos/issues/559) ∥ [#581](https://github.com/Jongtae/agentos/issues/581) → [#562](https://github.com/Jongtae/agentos/issues/562) → [#447](https://github.com/Jongtae/agentos/issues/447) → [#512](https://github.com/Jongtae/agentos/issues/512) → [#513](https://github.com/Jongtae/agentos/issues/513). Next: #559 and #581. #383/#437/#445 are outside the current Presence execution queue. |
