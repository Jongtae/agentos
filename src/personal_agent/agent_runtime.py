...
class Capabilities:
 ...
 def execute(self,name,args):
  ...
  if name.startswith('calendar_'):
   ...
   # `google-calendar-write`, the current owner-bound Calendar contract with
   # scope-exact, revision-bound checks. The retired MP1 assistant router is
   # preserved under scripts/legacy rather than kept as a second execution path.
