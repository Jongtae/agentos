...
HOST_ACTIONS={'web_search','public_page_read','bounded_public_research','weather','list_roots','find_files','read_file','list_notes','save_note','save_memory','list_memory','list_agents','delegate_agent'}
