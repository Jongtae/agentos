...
_RESET_CONFIG = ("telegram", "telegram_status", "model", "model_test", "subscription_engine", "document_sharing", "tool_run", "file_roots", "file_workspace", "file_workspace_document_jobs", "connector_contract_state", "connector_pending_work")
