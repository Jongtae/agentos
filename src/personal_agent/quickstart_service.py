...
class AgentService:
    ...
    def calendar_draft_request(self, body, owner_id=None):
        ...
        The model has no approve tool by design. The owner-local approval
        surface below is the only path that can mint and spend the one-time
        Calendar approval token.
